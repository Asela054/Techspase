                   ...
                   <div class="row">
                       <div class="col">
                           <div class="form-row mb-1">
                               ...
                               <div class="col">
                                <label class="small font-weight-bold text-dark">Shift Type*</label>
                                <select name="csv_shift" id="csv_shift" class="form-control form-control-sm" required>
                                    <option value="">Select Shift</option>
                                    @foreach ($shifttypes as $shifttype){
                                        <option value="{{$shifttype->id}}" >{{$shifttype->shift_name}}</option>
                                    }  
...
<script>
    ...
    $('#employeeshift_link').addClass('navbtnactive');
        ...
        $("#formsubmit").click(function () {
            ...
            let selectedDates = $('#fromdate').val().split(','); 
            
            if (!selectedEmployees || selectedEmployees.length === 0 || !selectedDates || selectedDates.length === 0) {
                alert('Please select at least one employee and one date.');
                return;
            }
        ...
        $('#btncreateorder').click(function () {
            ...
            if (tbody.children().length > 0) {
                ...
                var shift = $('#shift').val();  
                var selectedDates = $('#fromdate').val().split(',');  
