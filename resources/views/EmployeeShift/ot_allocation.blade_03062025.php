                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="form-row mb-1">
                                <div class="col-6">
                                    <label class="small font-weight-bold text-dark">Time From*</label>
                                    <input type="time" name="view_time_from" id="view_time_from" class="form-control form-control-sm" required readonly style="pointer-events: none"/>
                                </div>
                                <div class="col-6">
                                    <label class="small font-weight-bold text-dark">Time To*</label>
                                    <input type="time" name="view_time_to" id="view_time_to" class="form-control form-control-sm" required readonly style="pointer-events: none"/>
                                </div>
                            </div>
                            <div class="form-row mb-1">
                                <div class="col-6">
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" id="view_transport" name="view_transport" required readonly style="pointer-events: none"/>
                                        <label class="custom-control-label">Transport Applicable</label>
                                    </div>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" id="view_meal" name="view_meal" required readonly style="pointer-events: none"/>
                                        <label class="custom-control-label">Meal Applicable</label>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        $(document).on('click', '.view', function () {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $('#view_time_from').val(moment(data.result.mainData.time_from).format('HH:mm')); 
                    $('#view_time_to').val(moment(data.result.mainData.time_to).format('HH:mm'));
                    $('#view_transport').prop('checked', data.result.mainData.transport == 1);
                    $('#view_meal').prop('checked', data.result.mainData.meal == 1);
