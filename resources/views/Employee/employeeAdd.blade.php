                            ...
                            <form method="post" id="formemployee" class="form-horizontal">
                                ...
                                <div class="form-row mb-1">
                                    ...
                                    <div class="col">
                                        ...
                                        <select name="grade" class="form-control form-control-sm shipClass {{ $errors->has('grade') ? ' has-error' : '' }}">
                                            <option value="0">Please Select</option>
                                            @foreach($empgrade as $empgrades)
                                            <option value="{{$empgrades->id}}">{{$empgrades->grade}}</option>
                                            @endforeach
                                        </select>
                                        @if ($errors->has('grade'))
                                        <span class="help-block">
            ...
            columns: [
                ...
                },
                {
                    ...
                    render: function(data, type, row) {
                        ...
                        if (row.status == 1) {
                            buttons += '<a href="Employeestatus/' + row.id + '/1" onclick="return deactive_confirm()" target="_self" class="btn btn-outline-success btn-sm mr-1"><i class="fas fa-check"></i></a>';
                        } else {
                            buttons += '<a href="Employeestatus/' + row.id + '/2" onclick="return active_confirm()" target="_self" class="btn btn-outline-warning btn-sm mr-1"><i class="fas fa-times"></i></a>';
                        }
