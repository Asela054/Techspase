							...
							<div class="card shadow-none mb-3">
								<div class="card-body bg-light">
									...
									<div class="form-row">
										...
										<div class="col">
											<label class="small font-weight-bold text-dark">OT Allowed</label>
											<br>
											<div class="form-check-inline">
												<label class="form-check-label">
													<input type="radio" class="form-check-input ot_allowed" name="ot_allowed" id="ot_allowed_0" value="0" 
														{{ $employee->ot_allowed == 0 ? 'checked' : '' }}>No
												</label>
											</div>
											<div class="form-check-inline">
												<label class="form-check-label">
													<input type="radio" class="form-check-input ot_allowed" name="ot_allowed" id="ot_allowed_1" value="1"
														{{ $employee->ot_allowed == 1 ? 'checked' : '' }}>Yes
												</label>
											</div>
											</div>
									</div>
									<div class="form-row">
										...
										<div class="col">
											<label class="small font-weight-bold text-dark">Employee Grade</label>
											<select name="grade" id="grade"  class="form-control form-control-sm shipClass {{ $errors->has('grade') ? ' has-error' : '' }}">
												<option value="">Select</option>
												@foreach($empgrade as $empgrades)
													<option value="{{$empgrades->id}}"
															{{$empgrades->id == $employee->grade_id  ? 'selected' : ''}}
													>{{$empgrades->grade}}</option>
												@endforeach
											</select>
											@if ($errors->has('grade'))
												<span class="help-block">
									...
									<div class="form-row">
										<div class="col">
											<label class="small font-weight-bold text-dark"> Wages Category </label><br>
										...
										<div class="col">
											<label class="small font-weight-bold text-dark"> Transport Route </label><br>
											<select name="route_id" id="route_id"  class="form-control form-control-sm shipClass {{ $errors->has('route_id') ? ' has-error' : '' }}">
												<option value="">Select</option>
												@foreach($transportroute as $transportroutes)
													<option value="{{$transportroutes->id}}"
															{{$transportroutes->id == $employee->route_id  ? 'selected' : ''}}
													>{{$transportroutes->name}}</option>
												@endforeach
											</select>
										</div>
									</div>
