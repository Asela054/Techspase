                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-sm small" id="shiftextendreporttable" style="width: 100%">
                                    <thead>
                                        <tr>
                                            <th>EMP ID</th>
...
$(document).ready(function() {
    ...
    function load_dt() {
        $('#shiftextendreporttable').DataTable({
            ...
            serverSide: true,
            ajax: {
                "url": "{{url('/shift_extend_report_list')}}",
                "data": function(d) {
    ...
    $('#formFilter').on('submit', function(e) {
        e.preventDefault();
        $('#shiftextendreporttable').DataTable().ajax.reload();
    });
});
</script>
@endsection