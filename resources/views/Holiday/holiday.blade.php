                        ...
                        <div class="col">
                            ...
                            <form method="post" id="formTitle" class="form-horizontal">
                                ...
                                <div class="form-group mb-1">
                                    ...
                                    <input type="text" name="holiday_name" id="holiday_name" class="form-control form-control-sm" required/>
                                </div>
                                <div class="form-group mb-1">
                                ...
                                <div class="form-group mb-1">
                                    ...
                                    <input type="date" name="date" id="date" class="form-control form-control-sm" placeholder="YYYY-MM-DD"  required/>
                                </div>
                                <div class="form-group mb-1">
                                    <label class="small font-weight-bold text-dark">Work Level</label>
                                    <select name="work_level" id="work_level" class="form-control form-control-sm" required>
