                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <button type="button" class="btn btn-outline-primary btn-sm fa-pull-right" name="create_record"
                            id="create_record"><i class="fas fa-plus mr-2"></i>Add Weightage</button>
...
<script>
    $(document).ready(function () {
        ...
        $('#dataTable').DataTable({
            ...
            buttons: [{
                    ...
                    title: 'Functonal Weightage Details',
        ...
        $("#formsubmit").click(function () {
            if (!$("#formTitle")[0].checkValidity()) {
                ...
                $('#tableorder > tbody:last').append('<tr class="pointer"><td>' + parameter +
        ...
        $(document).on('click', '.edit', function () {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $('#weightage').val(data.result.weightage);
    ...
    if (type !== '') {
        $.ajax({
            url: '{!! route("functionalweightagegetkpifilter", ["type_id" => "type_id"]) !!}'
    ...
    $('#kpi').change(function () {
            ...
            if (kpi !== '') {
                $.ajax({
                    url: '{!! route("functionalweightagegetparameterfilter", ["kpi_Id" => "kpi_id"]) !!}'
                        .replace('kpi_id', kpi),
                    type: 'GET',
                    dataType: 'json',
                    success: function (data) {
