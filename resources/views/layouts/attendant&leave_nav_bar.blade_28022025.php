...
<div class="row nowrap" style="padding-top: 5px;padding-bottom: 5px;">
  ...
  @if(auth()->user()->can('MealAllowanceApprove-list') || auth()->user()->can('Holiday-DeductionApprove-list'))
  <div class="dropdown">
    <a  role="button" data-toggle="dropdown" class="btn navbtncolor" data-target="#" href="#" id="mealholiday">
      Meal & Holiday Deduction Approval <span class="caret"></span></a>
        <ul class="dropdown-menu multi-level dropdownmenucolor" role="menu" aria-labelledby="dropdownMenu">
          @can('MealAllowanceApprove-list')
            <li><a class="dropdown-item" href="{{ route('mealallowanceapproval')}}">Meal Allowance Approval</a></li>
            @endcan
            @can('Holiday-DeductionApprove-list')
            <li><a class="dropdown-item" href="{{ route('holidaydeductionapproval')}}">Holiday Deduction Approval</a></li>
            @endcan
        </ul>
  </div>
  @endif
