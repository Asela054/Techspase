...
<div class="row nowrap" style="padding-top: 5px;padding-bottom: 5px;">
  ...
  @if(auth()->user()->can('attendance-report')
      ...
      || auth()->user()->can('employee-shift-allocation-report')
      || auth()->user()->can('employee-shift-extend-report'))
  <div class="dropdown">
...
@if(auth()->user()->can('employee-ot-allocation-report'))
<div class="dropdown">
<a  role="button" data-toggle="dropdown" class="btn navbtncolor" data-target="#" href="#" id="otallocationreport">
  OT Allocation Reports<span class="caret"></span></a>
    <ul class="dropdown-menu multi-level dropdownmenucolor" role="menu" aria-labelledby="dropdownMenu">
      @can('employee-ot-allocation-report')
