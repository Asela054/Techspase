...
@elseif(request()->route()->getName() == 'nopay_attendances')
<ol class="breadcrumb custom-breadcrumb">
  <li class="breadcrumb-item"><a href="{{ route('attendenceleavedashboard')}}" class="breadcrumb-link breadcumpfont">Attendance & Leave</a></li>
  <li class="breadcrumb-item"><a href="#" class="breadcrumb-link breadcumpfont">Attendance</a></li>
  <li class="breadcrumb-item"><a href="{{route('nopay_attendances')}}" class="breadcrumb-link breadcumpfont">Nopay Attendances</a></li>
</ol>
...
<ol class="breadcrumb custom-breadcrumb">
  <li class="breadcrumb-item"><a href="{{ route('attendenceleavedashboard')}}" class="breadcrumb-link breadcumpfont">Attendance & Leave</a></li>
  <li class="breadcrumb-item"><a href="#" class="breadcrumb-link breadcumpfont">Attendance</a></li>
  <li class="breadcrumb-item"><a href="{{route('lateminitesapprovel')}}" class="breadcrumb-link breadcumpfont">Late Minites Approval</a></li>
</ol>
