<nav aria-label="breadcrumb" style="padding-top:8px;">
  <p class="navbar-brand d-none d-sm-block topbarcolor" style="font-weight: normal">
    ...
    @elseif(request()->route()->getName() == 'EmpGrade')
    <ol class="breadcrumb custom-breadcrumb">
      <li class="breadcrumb-item"><a href="{{ route('employeemanagementdashboard')}}" class="breadcrumb-link breadcumpfont">Employee Management</a></li>
      <li class="breadcrumb-item"><a href="#" class="breadcrumb-link breadcumpfont">Master Data</a></li>
      <li class="breadcrumb-item"><a href="{{route('EmpGrade')}}" class="breadcrumb-link breadcumpfont">Employee Grade</a></li>
    </ol>
...
@elseif(request()->route()->getName() == 'dailyhrsummary')
<ol class="breadcrumb custom-breadcrumb">
  <li class="breadcrumb-item"><a href="{{ route('attendenceleavedashboard')}}" class="breadcrumb-link breadcumpfont">Attendance & Leave</a></li>
  <li class="breadcrumb-item"><a href="{{route('dailyhrsummary')}}" class="breadcrumb-link breadcumpfont">Daily HR Summary</a></li>
</ol>
...
@elseif(request()->route()->getName() == 'leavetypereport')
<ol class="breadcrumb custom-breadcrumb">
  <li class="breadcrumb-item"><a href="{{ route('reportdashboard')}}" class="breadcrumb-link breadcumpfont">Reports</a></li>
  <li class="breadcrumb-item"><a href="{{route('leavetypereport')}}" class="breadcrumb-link breadcumpfont">Leave Type Report</a></li>
</ol>
@elseif(request()->route()->getName() == 'hrotreport')
<ol class="breadcrumb custom-breadcrumb">
  <li class="breadcrumb-item"><a href="{{ route('reportdashboard')}}" class="breadcrumb-link breadcumpfont">Reports</a></li>
  <li class="breadcrumb-item"><a href="{{route('hrotreport')}}" class="breadcrumb-link breadcumpfont">OT 60hr After Report</a></li>
</ol>
@elseif(request()->route()->getName() == 'absentdaysreport')
<ol class="breadcrumb custom-breadcrumb">
  <li class="breadcrumb-item"><a href="{{ route('reportdashboard')}}" class="breadcrumb-link breadcumpfont">Reports</a></li>
  <li class="breadcrumb-item"><a href="{{route('absentdaysreport')}}" class="breadcrumb-link breadcumpfont">Absent more than 3 days report</a></li>
</ol>
@elseif(request()->route()->getName() == 'nightshiftreport')
<ol class="breadcrumb custom-breadcrumb">
  <li class="breadcrumb-item"><a href="{{ route('reportdashboard')}}" class="breadcrumb-link breadcumpfont">Reports</a></li>
  <li class="breadcrumb-item"><a href="{{route('nightshiftreport')}}" class="breadcrumb-link breadcumpfont">Employee Night Shift Report</a></li>
</ol>
@elseif(request()->route()->getName() == 'shiftextendreport')
<ol class="breadcrumb custom-breadcrumb">
  <li class="breadcrumb-item"><a href="{{ route('reportdashboard')}}" class="breadcrumb-link breadcumpfont">Reports</a></li>
  <li class="breadcrumb-item"><a href="{{route('shiftextendreport')}}" class="breadcrumb-link breadcumpfont">Employee Shift Extend Report</a></li>
</ol>
@elseif(request()->route()->getName() == 'transportreport')
<ol class="breadcrumb custom-breadcrumb">
  <li class="breadcrumb-item"><a href="{{ route('reportdashboard')}}" class="breadcrumb-link breadcumpfont">Reports</a></li>
  <li class="breadcrumb-item"><a href="{{route('transportreport')}}" class="breadcrumb-link breadcumpfont">OT Transport report</a></li>
</ol>
@elseif(request()->route()->getName() == 'mealreport')
<ol class="breadcrumb custom-breadcrumb">
  <li class="breadcrumb-item"><a href="{{ route('reportdashboard')}}" class="breadcrumb-link breadcumpfont">Reports</a></li>
  <li class="breadcrumb-item"><a href="{{route('mealreport')}}" class="breadcrumb-link breadcumpfont">OT Meal report</a></li>
</ol>
