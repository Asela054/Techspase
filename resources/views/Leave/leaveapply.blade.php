                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <form method="post" id="formTitle" class="form-horizontal">
                                    ...
                                    <div class="form-row mb-1">
                                        <div class="col">
                                            <label class="small font-weight-bold text-dark">Inform / Not Inform</label>
                                            <select name="leavecat" id="leavecat"class="form-control form-control-sm">
                                                <option value="">Select</option>
                                                <option value="Inform">Inform Leave</option>
                                                <option value="Not Inform">Not Inform Leave</option>
                                            </select>
                                        </div>
                                    </div>
                    ...
                    columns: [
                        ...
                        { data: 'status', name: 'status' },
                        {
                            ...
                            "render": function(data, type, full) {
                                ...
                                if (canEditLeave) {
                                    button += '<button type="button" class="btn btn-outline-primary btn-sm edit_button" id="'+ uid +'" title="Edit">' +
                                            '<i class="fas fa-pencil-alt"></i>' +
                                            '</button> ';
                                }
                                if (canDeleteLeave) {
                                    button += '<button type="button" class="btn btn-outline-danger btn-sm delete_button" id="'+ uid + '"title="Delete">' +
