                ...
                if(type == 'Daily'){
                    ...
                    $('#ot_report_dt').DataTable({
                        ...
                        columns: [
                            ...
                            { data: 'poya_extended_normal_ot_hrs',
                                render: function(data, type, row) {
                                    let value = parseFloat(data);
                                        if (isNaN(value)) {
                                            return '0'; 
