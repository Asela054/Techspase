            ...
            function load_table(){
                ...
                $.ajax({
                    ...
                    success: function (res) {
                        ...
                        ot_data_html += '<th>Holiday OT Time</th>';
                        ot_data_html += '<th>Holiday D/OT Time</th>';
                        ot_data_html += '<th>Sunday D/OT</th>';
                        ot_data_html += '<th>Poya Ex. OT</th>';
                        ot_data_html += '<th>Poya Days</th>';
                        ot_data_html += '<th>Mercantile Days</th>';
                        ot_data_html += '<th>Sundays</th>';
                        ot_data_html += '</tr>';
                        ot_data_html += '</thead>';
                        ot_data_html += '<tbody>';
            ...
            $(document).on('click', '#btn_approve_ot', function(e) {
                ...
                cb.each(function(e1) {
                    ...
                    if(cb_obj.is(':checked')) {
                        ...
                        let holiday_ot_hours_input = cb_obj.parent().parent().find('td:nth-child(13) input');
                        let holiday_doubleot_hours_input = cb_obj.parent().parent().find('td:nth-child(14) input');
