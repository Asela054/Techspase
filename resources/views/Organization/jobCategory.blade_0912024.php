                        ...
                        <table class="table table-striped table-bordered table-sm small nowrap" style="width: 100%" id="dataTable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php
                                        if($jobcategories->work_hour_date == 0){
                                            echo 'Date';
                                        }elseif ($jobcategories->work_hour_date == 1){
                                            echo 'Hours';
                                        }
                                        ?>
                                    </td>
                                    ...
                                    <td>
                                        <?php
                                        if($jobcategories->lunch_deduct_type == 1){
                                            echo 'No';
                                        }elseif ($jobcategories->lunch_deduct_type == 0){
                                            echo 'Yes';
                                        }
                                        ?>
                                    </td>
...
{{--                                </div>--}}
                                ...
                                <div class="form-row mb-2">
                                <div class="col-md-4">
                                    <label class="small font-weight-bold text-dark">Working Hours Applicable</label>
                                    <br>
                                    <div class="form-check-inline">
                                        <label class="form-check-label">
                                            <input type="radio" class="form-check-input work_hour_date" name="work_hour_date" id="work_hour_date_0" value="0" checked>No
                                        </label>
                                    </div>
                                    <div class="form-check-inline">
                                        <label class="form-check-label">
                                            <input type="radio" class="form-check-input work_hour_date" name="work_hour_date" id="work_hour_date_1" value="1">Yes
                                        </label>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                ...
                                <div class="form-group mb-2">
                                    ...
                                    <div class="form-check-inline">
                                        <label class="form-check-label">
                                            <input type="radio" class="form-check-input lunch_deduct_type" name="lunch_deduct_type" id="lunch_deduct_type_1" value="1" checked>No
                                        </label>
                                    </div>
                                    <div class="form-check-inline">
                                        <label class="form-check-label">
                                            <input type="radio" class="form-check-input lunch_deduct_type" name="lunch_deduct_type" id="lunch_deduct_type_0" value="0">Yes
                                        </label>
                                    </div>
                                </div>
                                <div class="form-group mb-2 custom_lunch" style="display: none">
                                ...
                                <div class="form-group mb-2 custom_sun" style="display: none">
                                    <label class="small font-weight-bold text-dark">Custom Sunday OT Type</label>
                                    <br>
                                    <div class="form-check-inline">
                                        <label class="form-check-label">
                                            <input type="radio" class="form-check-input" name="custom_sunday_ot_type" id="custom_sunday_ot_type_1" value="1" checked>1
                                        </label>
                                    </div>
                                    <!-- <div class="form-check-inline">
                                        <label class="form-check-label">
                                    ...
                                    <div class="form-check-inline">
                                        <label class="form-check-label">
                                            <input type="radio" class="form-check-input" name="custom_sunday_ot_type" id="custom_sunday_ot_type_2" value="2">2
                                        </label>
                                    </div>
                                </div>
                                ...
                                <div class="form-group mb-2">
                                    ...
                                    <div class="form-check-inline">
                                        <label class="form-check-label">
                                            <input type="radio" class="form-check-input spe_day_1_type" name="spe_day_1_type" id="spe_day_1_type_0" value="0" checked>Custom
                                        </label>
                                    </div>
                                    <!-- <div class="form-check-inline">
                                        <label class="form-check-label">
                                ...
                                <div class="form-group mb-2 custom_spe">
                                    ...
                                    <div class="form-check-inline">
                                        <label class="form-check-label">
                                            <input type="radio" class="form-check-input" name="spe_day_1_rate" id="spe_day_1_rate_1" value="1" checked>1
                                        </label>
                                    </div>
                                    <!-- <div class="form-check-inline">
                                        <label class="form-check-label">
    ...
    $(document).on('click', '.edit', function () {
        ...
        $.ajax({
            ...
            success: function (data) {
               ...
               if(data.result.work_hour_date == 0){
                    $('#work_hour_date_0').prop( "checked", true );
                    $('.custom_work').css('display', 'none');
                }else if(data.result.work_hour_date == 1) {
               ...
               if(data.result.lunch_deduct_type == 1){
                    $('#lunch_deduct_type_1').prop( "checked", true );
                    $('.custom_lunch').css('display', 'none');
                }else if(data.result.lunch_deduct_type == 0) {
                ...
                if(data.result.custom_sunday_ot_type == 1.5 ){
                    $('#custom_sunday_ot_type_1_5').prop( "checked", true );
                }

                if(data.result.custom_sunday_ot_type == 2 ){
                ...
                if(data.result.spe_day_1_type == 1){
                    ...
                    $('#spe_day_1_type_2').prop( "checked", true );
                    $('.custom_spe').css('display', 'none');
                }
                ...
                if(data.result.spe_day_1_rate == 1.5 ){
                    $('#spe_day_1_rate_1_5').prop( "checked", true );
                }

                if(data.result.spe_day_1_rate == 2 ){
