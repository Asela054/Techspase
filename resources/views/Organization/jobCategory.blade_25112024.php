                        ...
                        <table class="table table-striped table-bordered table-sm small nowrap" style="width: 100%" id="dataTable">
                            <thead>
                                <tr>
                                    ...
                                    <th>Custom Special Day 01 OT Type</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php
                                        if($jobcategories->spe_day_1 == 1){
                                            echo 'As Act';
                                        }elseif ($jobcategories->spe_day_1 == 0){
                                            echo 'Custom';
                                        }else{
                                            echo 'Working Day';
                                        }
...
{{--                                </div>--}}
                                ...
                                <div class="form-group mb-1">
                                    ...
                                    <div class="form-check-inline">
                                        <label class="form-check-label">
                                            <input type="radio" class="form-check-input spe_day_1" name="spe_day_1" id="spe_day_1_1" value="1" checked>As Act
                                        </label>
                                    </div>
                                    <div class="form-check-inline">
                                        <label class="form-check-label">
                                            <input type="radio" class="form-check-input spe_day_1" name="spe_day_1" id="spe_day_1_0" value="0">Custom
                                        </label>
                                    </div>
                                    <div class="form-check-inline">
                                        <label class="form-check-label">
                                            <input type="radio" class="form-check-input spe_day_1" name="spe_day_1" id="spe_day_1_2" value="2">Special day is a working date
                                        </label>
                                    </div>
                                </div>
                                <div class="form-group mb-1 custom_spe" style="display: none">
...
$(document).ready(function(){
        ...
        $.ajax({
            ...
            success: function (data) {
               ...
               // $('#nopaydeduct').val(data.result.nopaydeduct);
                ...
                if(data.result.spe_day_1 == 1){
                    $('#spe_day_1_1').prop( "checked", true );
                    $('.custom_sat').css('display', 'none');
                }else if(data.result.spe_day_1 == 0) {
                    $('#spe_day_1_0').prop( "checked", true );
                    $('.custom_sat').css('display', 'block');
                }else{
                    $('#spe_day_1_2').prop( "checked", true );
                    $('.custom_sat').css('display', 'none');
                }
    ...
    $(document).on('change', '.spe_day_1', function (e) {
        let val = $(this).val();
        if(val == 0){
