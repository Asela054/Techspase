...
{{--                                </div>--}}
                                ...
                                <div class="form-row mb-2">
                                    <div class="col-md-4">
                                        ...
                                        <input type="number" name="holiday_work_hours" step="0.01" id="holiday_work_hours" class="form-control form-control-sm" required />
                                    </div>
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-check-inline">
                                            <label class="form-check-label">
                                                <input type="radio" class="form-check-input work_hour_date" name="work_hour_date" id="work_hour_date_0" value="Date" checked>Monthly
                                            </label>
                                        </div>
                                        <div class="form-check-inline">
                                            <label class="form-check-label">
                                                <input type="radio" class="form-check-input work_hour_date" name="work_hour_date" id="work_hour_date_1" value="Hour">Week/Daily
                                            </label>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-row mb-2">
                                    ...
                                    <div class="col-md-4 custom_spe" style="display: none">
...
$(document).ready(function(){
        ...
        $.ajax({
            ...
            success: function (data) {
               ...
               if(data.result.lunch_deduct_type == 0){
                ...
                if (data.result) { 
                    $('#spe_day_1_day').val(data.result.spe_day_1_day).change(); 
    ...
    $(document).on('change', '#spe_day_1_day', function () {
        let val = $(this).val();
        if (val === "") { 
            $('.custom_spe').hide();
        } else {
