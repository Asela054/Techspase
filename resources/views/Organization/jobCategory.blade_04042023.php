                            ...
                            <form method="post" id="formTitle" class="form-horizontal">
                                ...
                                <div class="form-row mb-1">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <input type="text" name="annual_leaves" id="annual_leaves" class="form-control form-control-sm" />
                                    </div>                                    
                                </div>
                                <div class="form-group mb-1">
                                    <label class="small font-weight-bold text-dark">Casual Leaves</label>
                                    <input type="text" name="casual_leaves" id="casual_leaves" class="form-control form-control-sm" />
                                </div>
                                <div class="form-row mb-1">
                                    <div class="col-12">
                                        <label class="small font-weight-bold text-dark">Medical Leaves</label>
                                        <input type="text" name="medical_leaves" id="medical_leaves" class="form-control form-control-sm" />
                                    </div>
                                    <div class="col-12">
                                        <label class="small font-weight-bold text-dark">Normal OT Rate</label>
                                        <input type="number" name="normal_ot_rate" step="0.01" id="normal_ot_rate" class="form-control form-control-sm" />
                                    </div>                                    
                                </div>
                                <div class="form-group mb-1">
                                    <label class="small font-weight-bold text-dark">Double OT Rate</label>
                                    <input type="number" name="double_ot_rate" step="0.01" id="double_ot_rate" class="form-control form-control-sm" />
                                </div>
                                <div class="form-group mb-1">
                                    <label class="small font-weight-bold text-dark">No Pay Rate Per Hour</label>
                                    <input type="number" name="no_pay_rate_per_hour" step="0.01" id="no_pay_rate_per_hour" class="form-control form-control-sm" />
                                </div>
                                <div class="form-group mb-1">
                                    <label class="small font-weight-bold text-dark">No Pay Rate Per Day</label>
                                    <input type="number" name="no_pay_rate_per_day" step="0.01" id="no_pay_rate_per_day" class="form-control form-control-sm" />
                                </div>
