...
{{--                                            <input type="checkbox" name="short_leave_enabled" class="form-check-input" id="short_leave_enabled">--}}
{{--                                            <label class=" font-weight-bold text-dark" for="short_leave_enabled">Allow Short Leave</label>--}}
{{--                                        </div>--}}
{{--                                    </div>--}}
{{--                                </div>--}}
