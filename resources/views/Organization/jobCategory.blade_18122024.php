                        ...
                        <table class="table table-striped table-bordered table-sm small nowrap" style="width: 100%" id="dataTable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{$jobcategories->late_attend_min}}</td>
                                    <td>
                                        <?php
...
{{--                                </div>--}}
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="number" name="late_attend_min" id="late_attend_min" class="form-control form-control-sm" required />
                                </div>
                                <div class="col-md-4">
