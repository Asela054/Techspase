                                ...
                                <div id="default">
                                    <div class="card card-header-actions mb-4">
                                        <div class="card-header">
                                            Additions
                                            <button type="button" name="create_record" id="create_record" class="btn btn-outline-primary btn-sm fa-pull-right px-4"><i class="fas fa-plus"></i>&nbsp;Add</button>
                                        </div>
                                        <div class="card-body">
                                   ...
                                   <div class="modal-body">
                                       ...
                                       {{ csrf_field() }}
                                           <div class="sbp-preview">
                                               ...
                                               <div class="" align="right" style="padding:5px; border-top:none;">
                                               	   <input type="submit" name="setup_button" id="setup_button" class="btn btn-primary" value="Edit" />
...
$(document).ready(function(){
 ...
 var remunerationTable=$("#titletable").DataTable({
		"columnDefs":[{
				...
				"orderable":false,
				render:function( data, type, row ){
					return '<button name="edit" data-refid="'+data+'" class="edit btn btn-primary btn-datatable btn-icon mr-2" type="submit">'+
