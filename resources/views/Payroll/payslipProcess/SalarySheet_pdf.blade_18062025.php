                        ...
                        <td>
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: right;">{{ number_format((float)$ot4tl_poyaval_original, 2, '.', ',') }}</td>
                                </tr>
                                <tr>
                                    <td>වෙළද නිවාඩු ගෙවීම් ({{$mercantile_workhrs}})</td>
                                    <td style="text-align: right;">{{ number_format((float)$ot5tl_mercantileval_original, 2, '.', ',') }}</td>
                                </tr>
                                <tr>
