	...
	var empTable=$("#emptable").DataTable({
			...
			"columnDefs":[{
				...
				render: function( data, type, row ){
					var nopay_days = parseFloat(row.nopay_days);
					var holiday_nopay_days = parseFloat(row.holiday_nopay_days);
					var tot_nopay_days = nopay_days+holiday_nopay_days;
					return (tot_nopay_days==0)?'0.00':parseFloat((parseFloat(data)/tot_nopay_days)*nopay_days).toFixed(2);
				}
			}],
