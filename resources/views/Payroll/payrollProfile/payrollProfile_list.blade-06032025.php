                                ...
                                <div id="default">
                                    <div class="card card-header-actions mb-4">
                                        <div class="card-header">
                                            Pay-slip Details
                                            <button type="button" name="create_record" id="create_record" class="btn btn-success btn-sm"><i class="fas fa-plus mr-2"></i>Search</button>
                                        </div>
                                        <div class="card-body">
                                            <form id="frmInfo" method="post">
                                                ...
                                                <div class="sbp-preview">
                                                    <div class="sbp-preview-content">
                                                       ...
                                                       <div class="row">
                                                           <div class="form-group col-md-4">
                                                               ...
                                                               <div class="col">
                                                                 <select name="payroll_act_id" id="payroll_act_id" class="form-control" required>
                                                           ...
                                                           <div class="form-group col-md-4">
                                                               ...
                                                               <div class="col">
                                                                 <select name="payroll_process_type_id" id="payroll_process_type_id" class="form-control" required>
                                                       ...
                                                       <div class="row">
                                                           ...
                                                           <div class="form-group col-md-4">
                                                               ...
                                                               <div class="col">
                                                                 <input type="text" name="basic_salary" id="basic_salary" class="form-control" autocomplete="off" required/>
                                                               </div>
                                                           </div>
                                                           <div class="form-group col-md-4">
                                                    ...
                                                    <div class="sbp-preview-text" style="text-align:right; padding:10px;">
                                                        ...
                                                        <input type="submit" name="action_button" id="action_button" class="btn btn-primary" value="Save Profile" />
                                                    </div>
                                                </div>
                                            </form>
		...
		"columnDefs":[{
				...
				render:function( data, type, row ){
					if(row[0]=='-'){
						...
						return '<button name="edit" data-refid="'+data+'" data-refpack="'+((row[0]=='-')?'':row[4])+'" class="edit btn btn-primary btn-datatable btn-icon mr-2" type="button">'+'<i class="fas fa-edit"></i></button>'+del_str;
					}
				}
			}],
		"createdRow": function( row, data, dataIndex ){
