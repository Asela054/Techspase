                                ...
                                if($ot_minutes >= $otminimumminits){
                                    ...
                                    if($sunafterdoublehours>0){
                                        ...
                                        if($ot_hours>$sunafterdoublehours){
                                            $double_ot_hours=floor(($ot_hours-$sunafterdoublehours));
                                            $ot_hours = 0;
                                            $holidayot = $sunafterdoublehours;
                                            $total_ot_hours += ($holidayot+$double_ot_hours);
                                        }
                                        else{
                                            $ot_hours = $ot_hours;
                            ...
                            if($on_time < $shift_start && $morningotstatus == 1) { //Morning ot
                                ...
                                if($ot_minutes >= $otminimumminits){
                                    if($is_double){
                                        ...
                                        $one_point_five_ot_hours += floor($ot_minutes / 60);
                                    }else{
                                        $ot_hours += floor($ot_minutes / 60);
                                    }  
                                }
