					...
					*/
					...
					if(empty($employeePayslip)){
						...
						*/
						...
						$sql_update.="FROM `employee_salary_payments` WHERE `payroll_profile_id`=? AND `emp_payslip_no`=? AND (fig_value>0) AND (epf_payable=1 OR remuneration_payslip_spec_code IN ('ATTBONUS_W'))) AS drv_calc) AS drv_info ";
